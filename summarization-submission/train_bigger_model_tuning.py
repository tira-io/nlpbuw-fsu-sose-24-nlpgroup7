...
training_args = Seq2SeqTrainingArguments(
    output_dir="./results_bigger_model_tuning/",
    eval_strategy="epoch",
    learning_rate=2e-5,
    ...
    save_strategy="epoch",  # Save based on steps
    metric_for_best_model="eval_rouge1",  # Select the best model based on ROUGE-1 score
...
# Save the model
model.save_pretrained("./results_bigger_model_tuning/trained_model")
tokenizer.save_pretrained("./results_bigger_model_tuning/trained_model")

# Log final evaluation results
with open("./results_bigger_model_tuning/metrics_log.txt", "a") as writer:
