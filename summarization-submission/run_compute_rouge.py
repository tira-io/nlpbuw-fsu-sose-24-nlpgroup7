...
if __name__ == "__main__":
    ...
    model_path = "./results_best_perf2/trained_model"
    ...
    with open("./results_compute_rouge/metrics_log.txt", "a") as writer:
    ...
    df.to_json(
        Path(output_directory) / "results_compute_rouge/predictions.jsonl", orient="records", lines=True
    )
